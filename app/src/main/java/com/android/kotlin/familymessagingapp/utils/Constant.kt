...
object Constant {
    ...
    const val FIREBASE_REALTIME_DATABASE_PRIVATE_USER_DATA_REF_NAME = "private_user_data"
    ...
    const val NEW_CHATROOM_MEMBERS_SOCKET_EVENT = "NEW_CHATROOM_MEMBERS_SOCKET_EVENT"
